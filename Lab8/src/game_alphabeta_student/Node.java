...
public class Node {
	...
	public static Comparator<Node> LabelLeftToRigthComparator = new Comparator<Node>() {
		@Override
		public int compare(Node o1, Node o2) {
			return o1.getLabel().compareTo(o2.getLabel());
		}
	};
	public static Comparator<Node> LabelRightToLeftComparator = new Comparator<Node>() {
		@Override
		public int compare(Node o1, Node o2) {
